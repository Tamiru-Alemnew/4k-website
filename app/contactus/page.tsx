...
import { faTelegram, faInstagram, faTwitter, faTiktok, faLinkedin } from '@fortawesome/free-brands-svg-icons';
                    ...
                    <ul className="flex mt-12 space-x-4">
                        <li className="h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <Link href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='blue'
                                    viewBox="0 0 24 24">
                                    <path
                        ...
                        <li className=" h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <Link href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" fill='purple'
                                    viewBox="0 0 511 512">
                                    <path
